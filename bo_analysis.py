...
def optimize(shared_lib: str, input_type: str, num_inputs: int, splitting: int, new_max: float):
    ...
    for f in funcs:
        ...
        BO_bounds = Input_bound(split=splitting, num_input=num_inputs, input_type=input_type, input_range=[-100, 100], f_type=f)
